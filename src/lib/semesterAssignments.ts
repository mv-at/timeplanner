const pflichtfaecher: Schedule[] = [
    {name: "AVS", color: "#ff8723",  url: "https://tc.tugraz.at/main/course/view.php?id=364", tasks: [
    ...
    {name: "D & A", color: "#fffa1a",  url: "https://tc.tugraz.at/main/course/view.php?id=1561", tasks: [
            {name: "Blatt 1", start: new Date("3.8.2024").getTime(), end: new Date("3.22.2024").getTime()},
        ]},
    {name: "Data Management", color: "#00a3ff",  url: "https://tc.tugraz.at/main/course/view.php?id=1998", tasks: []},
    {name: "Signalverarbeitung", color: "#03be5c",  url: "https://tc.tugraz.at/main/course/view.php?id=615", tasks: [
    ...
    {name: "SigV KV", color: "#11ad14",  url: "https://tc.tugraz.at/main/course/view.php?id=2400", tasks: [
    ...
    {name: "SLP", color: "#e51616", url: "https://www.iaik.tugraz.at/teaching/materials/slp/assignments/", tasks: [
...
const freifaecher: Schedule[] = [
    {name: "Programmieren C++", color: "#a21862",  url: "https://imsc.uni-graz.at/haasegu/Lectures/Kurs-C/SS24/index.html", tasks: [
