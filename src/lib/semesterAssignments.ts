const semester: Schedule[] = [
    {name: "SLP", color: "#da0909", url: "https://www.iaik.tugraz.at/teaching/materials/slp/assignments/", tasks: [
    ...
    {name: "AVS", color: "#e8852e",  url: "https://tc.tugraz.at/main/course/view.php?id=364", tasks: [
    ...
    {name: "Signalverarbeitung", color: "#11a489",  url: "https://tc.tugraz.at/main/course/view.php?id=615", tasks: [
    ...
    {name: "SigV KV", color: "#115ba4",  url: "https://tc.tugraz.at/main/course/view.php?id=2400", tasks: [
    ...
    {name: "Data Management", color: "#11ad14",  url: "https://tc.tugraz.at/main/course/view.php?id=1998", tasks: []},
    {name: "D & A", color: "#d2cd07",  url: "https://tc.tugraz.at/main/course/view.php?id=1561", tasks: [
